...
func startDeschedulerServer(t *testing.T, ctx context.Context, clientSet clientset.Interface, namespace string) *appsv1.Deployment {
	...
	deschedulerDeploymentObj := deschedulerDeployment(namespace)
